...
export default function ButtonAppBar() {
  return (
    <>
      ...
      >
        <div className="w-[50%] flex justify-center mt-7 items-center rounded-full border-2 border-black">
          <input
            type="text"
            name="search"
            placeholder="Search Google or type a URL"
            className=" w-[90%] rounded-full p-3 focus:border-transparent focus:outline-none"
          />
